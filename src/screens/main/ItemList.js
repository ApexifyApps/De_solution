...
const ItemList = ({ navigation, route }) => {
    ...
    return (
        <View style={{ flex: 1, backgroundColor: APPCOLORS.BTN_COLOR, padding: 20, paddingBottom: 0 }}>
            ...
            <Text style={{ color: APPCOLORS.WHITE, fontSize: 25, fontWeight: 'bold', marginTop: 10 }}>Grand Total: Rs {GrandCartTotalPrice}</Text>
                                ...
                                {/* 
                                {
                                    Editing == true ?
                                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                            <TouchableOpacity style={{ borderRadius: 4, backgroundColor: 'blue', height: 40, width: 40, alignItems: 'center', justifyContent: 'center' }}>
                                                <Text style={{ color: 'white', fontWeight: 'bold', fontSize: 25 }}>-</Text>
                                            </TouchableOpacity>
                                            <Text style={{ color: APPCOLORS.BLACK, fontSize: 15, marginRight: 10, marginLeft: 10 }}>{item?.quantity_ordered}</Text>
